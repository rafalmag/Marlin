...
// RM: P1_24 has PWM, but the frequency is low 50Hz, it would be good to try higher freq.
  ...
  #define CASE_LIGHT_DEFAULT_BRIGHTNESS 5   // Set default power-up brightness (0-255, requires PWM pin)
